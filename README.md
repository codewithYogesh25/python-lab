...
| :--- | :--- | :--- |
| Basics | Basic syntax, variables, and data types. | ✅ Completed |
| Input/Output | Learning user input and print statements. | ✅ Completed |
| Control Flow | Implementing loops and conditional statements. | ✅ Completed |
| Functions | Writing reusable code and modules. | ⏳ In Progress |
